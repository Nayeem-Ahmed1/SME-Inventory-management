<div class="all_container">
  ...
  $results = dbQuery(" SELECT inventory.*, products.product_name, warehouses.warehouse_name
    FROM inventory
    JOIN products
    ON inventory.product_id = products.product_id
    JOIN warehouses
    ON inventory.warehouse_id = warehouses.warehouse_id
    WHERE ( inventory.current_stock - inventory.reserved_stock - inventory.damaged_stock) <= 0
